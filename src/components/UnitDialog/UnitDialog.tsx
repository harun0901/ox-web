...
export const UnitDialog: React.FC<UnitDialogProps> = ({ isOpen, onClose, unit }) => {
  ...
  const [selectedBuildingId, setSelectedBuildingId] = useState<definitions['Asset']['assetId']>('')
  const [selectedFloorId, setSelectedFloorId] = useState<definitions['Asset']['assetId']>('')
  const [unitName, setUnitName] = useState<definitions['Unit']['name']>('')
  const [selectedBeds, setSelectedBeds] = useState<SelectedBedsState>({})
